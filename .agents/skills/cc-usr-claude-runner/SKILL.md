...
description: Select QC-passed SQLite batch question numbers and launch Claude Code sessions in their working folders using the root .env connection settings. Automatically uses iTerm2 on macOS when available and headless mode elsewhere. Not for scoring, trajectory inspection, or Excel export.
---
...
- Claude Code must be available. iTerm2 is only needed for local macOS interactive launches.
