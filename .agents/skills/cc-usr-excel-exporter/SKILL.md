...
description: Export selected delivery-QC-passed SQLite records to a new 28-column CC_Codex workbook and copy their original Claude Code JSONL trajectories into the batch directory. Never generate, infer, or rewrite record values.
---
