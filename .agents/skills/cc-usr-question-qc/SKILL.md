...
description: Quality-check SQLite-backed Coding Agent batch questions before production for difficulty, banned topics, diversity, repository, snapshot, and reproducibility. Never inspect model responses or trajectories.
---
...
3. Semantically check primary intent, first-turn difficulty, repository dependence, objective acceptance, single-file escape risk, prohibited topics, and template-like similarity.
...
- Require a full GitHub commit permalink, a clean prepared workspace, accurate reproducibility metadata, and concrete repository evidence.
